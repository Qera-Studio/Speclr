...
const FORM_GROUP_INHERIT =
  "group-data-[size=form]/field-group:h-9 group-data-[size=form]/field-group:px-3 group-data-[size=form]/field-group:py-1 group-data-[size=form]/field-group:text-sm"
